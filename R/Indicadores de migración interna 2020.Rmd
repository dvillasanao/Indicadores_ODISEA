...
for(i in 1:2){
  for(j in 1:3) {
   for(k in 1:7) {
     ...
     x_lim <- ifelse(n <= 40, 20, 
                     ifelse(n > 200, 80, 
                             60))
     
     # Ajuste en nudge_y
     nudge_y_muestra = ifelse(n < 100, -5, 
                              ifelse(n >= 100 & n <= 200, -9, 
                               ifelse (n > 200 & n < 300, -9, 
                                 ifelse(n >= 300, -15, -9))))
     
     nudge_y_censo = ifelse(n >= 100, 9, 7)
                                                                           ...
                                                                           geom_ribbon(aes(ymin = TEmigracion_low, 
                                                                             ...
                                                                             geom_line(aes(y = TEmigracion_Censo, 
                                                                              ...
                                                                              geom_text_repel(aes(y = limite_muestra, 
                                                                                              ...
                                                                                              min.segment.length = 0.1,
                                                                                              #ylim = c(min(tabla1$TEmigracion_low) -30, max(tabla1$TEmigracion_low) - 30),
                                                                                              ylim = c(-1 *max(tabla1$TEmigracion_low), -1 * min(tabla1$TEmigracion_low)),
                                                                                              segment.size = 0.02,
                                                                              ...
                                                                              geom_text_repel(aes(y = limite_censo, 
                                                                                              ...
                                                                                              direction = "y",
                                                                                              min.segment.length = 0.1,
                                                                                              ylim = c(min(tabla1$TEmigracion_upp, tabla1$TEmigracion_Censo) + 20 , max(tabla1$TEmigracion_upp, tabla1$TEmigracion_Censo) + 40),
...
p
path = paste0(here::here(), "/Graficos/MR5a (TEmigracion) a nivel municipal_Tamaño de municipio_1.pdf") 
ggexport(list = p, width = 12, height = 7, dpi = 400, filename = path, device = "cairo_pdf")      
```
