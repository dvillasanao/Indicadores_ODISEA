...
mydata <- mydata %>%
           select(ID_VIV, ID_PERSONA, CVE_ENT, ENT, MUN, CVE_MUN, LOC50K, COBERTURA, ENT_PAIS_NAC, ENT_PAIS_RES_5A, MUN_RES_5A, CVE_MUN_RES15, EDAD, COBERTURA, FACTOR, ESTRATO, UPM) %>%
           mutate(M = 1)  %>%
...
```{r, echo = FALSE, eval = FALSE}
 geom_text(aes(y = -20, label = format(TInmigracion, digits = 1, nsmall = 1L, big.mark   = " ", scientific = FALSE)), 
                                                                                       size = 2, 
                                                                                        angle = 90, 
                                                                                         family = "Montserrat Medium",
                                                                                          color = lineas[k]) +
                                                                            geom_text(aes(y = -40, label = format(TInmigracion_Censo, digits = 1, nsmall = 1L, big.mark   = " ", scientific = FALSE)), 
                                                                                       size = 2, 
                                                                                        angle = 90,
                                                                                         family = "Montserrat Medium",
                                                                                          color = "#000000") +
